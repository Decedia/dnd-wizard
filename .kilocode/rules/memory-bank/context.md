...
| 2026-08-31 | Implemented MTF race options: Eladrin season choice (4 options), Githyanki Decadent Mastery (language + proficiency). Added raceChoices to Character type, choice selection UI in StepRace and StepOrigin popups, and display in IdentitySection character sheet; typecheck and build pass |
