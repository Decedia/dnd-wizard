...
| 2026-08-31 | Added SCAG (Sword Coast Adventurer's Guide) content: 5 spells (Tenser's Floating Disk, Cordon of Arrows, Melf's Acid Arrow, Nystul's Magic Aura, Phantasmal Force), 9 feats (Blade Master, Diplomat, Divinely Favored, Everybody's Friend, Favored by the Gods, Gift of the Chromatic Dragon, Gift of the Dragon Champion, Gift of the Metallic Dragon, Svirfneblin Magic), 1 race (Deep Gnome/Svirfneblin); added 4 SCAG wizard spells to wizard spell list (total 227); updated StepRace.tsx, StepOrigin.tsx, and IdentitySection.tsx to pass sources to getStaticRaces(); typecheck and build pass |
| 2026-08-31 | Added source badges to subclass features in LevelUpWizard. Changed level navigation to scroll to clicked level card instead of removing higher levels. Level buttons now show all levels from min to target, clicking scrolls to that level card; typecheck and build pass |
