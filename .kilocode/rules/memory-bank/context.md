...
| 2026-08-24 | Reordered creation wizard steps to: Identity → Class → Race → Abilities → Skills → Equipment → Spells → Appearance → Level → Subclass; Skills now immediately follows Ability Scores; lint and typecheck pass |
