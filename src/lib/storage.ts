...
export interface Character {
  ...
  inventory: { id: string; name: string; quantity: number; equipped: boolean; hand?: "main" | "off" | "both"; source: "srd" | "custom"; srdItemName?: string; itemType?: "weapon" | "armor" | "item" | "instrument"; category?: "melee" | "ranged" | string; damageDice?: string; damageType?: string; baseAC?: number; armorType?: "light" | "medium" | "heavy" | "shield"; maxDexBonus?: number | null; choiceGroupIndex?: number; choiceOptionIndex?: number; isGranted?: boolean; description?: string; properties?: string[]; ammoQuantity?: number; maxAmmo?: number; range?: { normal: number; long: number }; weight?: number | null; value?: string | null; versatileDice?: string | null; stealthDisadvantage?: boolean; strengthRequirement?: number; toolUse?: string; associatedAbility?: string; effect?: string; uses?: number; icon?: string }[];
