...
export const equipment: SRDEquipment[] = [
  ...
  { name: "Diplomat's Pack", description: "Includes a chest, 2 map or scroll cases, fine clothes, ink, ink pen, lamp, 2 flasks of oil, 5 sheets of paper, perfume, sealing wax, and soap.", type: "item" },
  { name: "Entertainer's Pack", description: "Includes a backpack, bedroll, 2 sets of costume clothes, 5 candles, 5 days of rations, a waterskin, and a disguise kit.", type: "item" },
  { name: "Priest's Pack", description: "Includes a backpack, blanket, 10 candles, tinderbox, 2 days of rations, a waterskin, alms box, 2 blocks of incense, censer, and vestments.", type: "item" },
