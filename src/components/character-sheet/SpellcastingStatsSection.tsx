...
export function SpellcastingStatsSection({ character, onChange }: SpellcastingStatsSectionProps) {
  ...
  return (
    <SectionCard id="spellcasting" title="Spellcasting Stats" icon={<SpellcastingIcon className="h-5 w-5" />}>
      ...
      <div className="mt-4">
        <span className="text-[10px] font-medium text-parchment/60 uppercase tracking-wider">Cantrips</span>
      ...
      <div className="mt-4">
        <span className="text-[10px] font-medium text-parchment/60 uppercase tracking-wider">Spell Slots</span>
