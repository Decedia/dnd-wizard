...
function buildLevelInfos(
  ...
  for (let level = loopStart; level <= targetLevel; level++) {
    ...
    infos.push({
      ...
      asi,
      spellSlots,
      cantripsKnown: isArcaneTrickster ? cantripsKnown : undefined,
      spellsKnown: isArcaneTrickster ? spellsKnown : undefined,
      classFeatures,
      subclassOptions,
      ...
      hasSpellSelection: isArcaneTrickster ? hasSpellSelection : false,
      spellSelectionCount: isArcaneTrickster ? spellSelectionCount : 0,
      cantripSelectionCount: isArcaneTrickster ? cantripsDelta : 0,
      maxSpellLevel,
      spellsKnownChanged,
      prevSpellsKnown,
      magicalSecretsCount,
