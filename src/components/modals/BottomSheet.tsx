...
export function BottomSheet({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      />
      <div
        className={`relative w-full max-w-sm max-h-[480px] mb-24 flex flex-col bg-[var(--color-surface)] rounded-2xl border border-[var(--color-border)] shadow-2xl overflow-hidden ${className}`}
